...
def button_callback():
    ...
    if optionmenu_Curso.get() == "Taxista" and optionmenu_Estado.get() == "Rio de Janeiro (Goytacazes)":
    ...
    if optionmenu_Curso.get() == "Perigosos" and optionmenu_Estado.get() == "Santa Catarina":
    ...
    if optionmenu_Curso.get() == 'Atualização Perigosos' and optionmenu_Estado.get() == "Rio Grande do Sul":
        certificado_template = 'templates/att_mopp_rs.docx'
    if optionmenu_Curso.get() == 'Taxista' and optionmenu_Estado.get() == "Santa Catarina":
        certificado_template = 'templates/tx_sc.docx'
    if optionmenu_Curso.get() == 'Atualização Escolar' and optionmenu_Estado.get() == "Rio Grande do Sul":
        certificado_template = 'templates/att_escolar_rs.docx'
    if optionmenu_Curso.get() == 'Taxista' and optionmenu_Estado.get() == "Rio de Janeiro":
        certificado_template = 'templates/tx_rj.docx'
    if optionmenu_Curso.get() == 'Perigosos' and optionmenu_Estado.get() == "Rio Grande do Sul":
        certificado_template = 'templates/mopp_rs.docx'
    if optionmenu_Curso.get() == 'Atualização Passageiros' and optionmenu_Estado.get() == "Rio Grande do Sul":
        certificado_template = 'templates/att_passageiros_rs.docx'
    if optionmenu_Curso.get() == 'Passageiros' and optionmenu_Estado.get() == "Rio Grande do Sul":
        certificado_template = 'templates/passageiros_rs.docx'
    if optionmenu_Curso.get() == 'Escolar' and optionmenu_Estado.get() == "Rio Grande do Sul":
        certificado_template = 'templates/escolar_rs.docx'
    if optionmenu_Curso.get() == 'Escolar' and optionmenu_Estado.get() == "Santa Catarina":
        certificado_template = 'templates/escolar_sc.docx'
    if optionmenu_Curso.get() == 'Passageiros' and optionmenu_Estado.get() == "Santa Catarina":
        certificado_template = 'templates/passageiros_sc.docx'
...
optionmenu_Estado = customtkinter.CTkOptionMenu(frame_1, values=["Santa Catarina", "Rio Grande do Sul", "Pernambuco",
                                                                 "Rio de Janeiro", "Rio de Janeiro (Goytacazes)"])
optionmenu_Estado.pack(pady=10, padx=10)
optionmenu_Estado.set("Selecione o Estado")

optionmenu_Curso = customtkinter.CTkOptionMenu(frame_1, values=["Reciclagem",
                                                                "Taxista",
                                                                "Perigosos",
                                                                "Emergência",
                                                                "Escolar",
                                                                "Passageiros",
                                                                "Atualização Perigosos",
                                                                "Atualização Emergência",
                                                                "Atualização Escolar",
                                                                "Atualização Passageiros"])
...
entry_ID.place(anchor=tkinter.W, rely=0.30, relx=0.05)
